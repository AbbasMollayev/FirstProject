...
export default class JobTable extends LightningElement {
  columns = [
    ...
    { label: "Job Location", fieldName: "location" },
    { label: "Job Salary", fieldName: "salary" }
  ];
  ...
  jobs = [
    ...
    {
      jobId: 6,
      jobTitle: "Salesforce Data Analyst",
      location: "Austin",
      salary: 80000
    },
    {
      jobId: 7,
      jobTitle: "Salesforce Solutions Engineer",
      location: "Dallas",
      salary: 120000
    },
    {
      jobId: 8,
      jobTitle: "Salesforce Technical Lead",
      location: "Boston",
      salary: 160000
    },
    {
      jobId: 9,
      jobTitle: "Salesforce Systems Analyst",
      location: "Miami",
      salary: 90000
    },
    {
      jobId: 10,
      jobTitle: "Salesforce Product Manager",
      location: "Denver",
      salary: 115000
    }
  ];
